...
PATH=~/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:/usr/bin/X11:/usr/X11R6/bin:/usr/games:~/work/utils:~/work/mkat:~/work/dev-scripts:/snap/bin:.git/safe/../../bin
...
if [ -n "$PS1" ]; then
  ...
  # Run the last started container with root user.
  function derlast() {
