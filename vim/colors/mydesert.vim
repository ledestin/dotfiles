" Updated the theme to use a better comment color. Dmitry Maksyoma.
"
" Vim color file
...
hi IncSearch	cterm=none ctermbg=blue ctermfg=black guifg=slategrey guibg=khaki
"hi LineNr
hi ModeMsg		guifg=goldenrod
hi MoreMsg 		ctermfg=LightGreen guifg=SeaGreen
hi NonText 		ctermfg=LightBlue guifg=LightBlue guibg=grey30
hi Question		guifg=springgreen
hi Search	ctermbg=blue ctermfg=black guibg=peru guifg=wheat
...
hi Comment 	ctermfg=26 guifg=SkyBlue
